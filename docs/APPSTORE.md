...
• Hi-res stillness keyframes: hold still to capture native-resolution photos for maximum texture detail — a reticle, shutter feedback, and an amber/clear coverage overlay show where photos are still needed
